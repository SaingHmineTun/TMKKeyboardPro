...
public class MyanmarKeyboard {
    ...
    private static MyanmarKeyboard instance;

    public static MyanmarKeyboard getInstance(ShanKeyboardService context) {
        if (instance == null) {
            instance = new MyanmarKeyboard(context);
        }
        return instance;
    }

    public MyanmarKeyboard(ShanKeyboardService context) {
    ...
    public String handelMyanmarInputText(int primaryCode, InputConnection ic) {
        ...
        if (primaryCode == MY_E && SharedPreferenceManagerKt.getHandWritingSystem(context)) {
